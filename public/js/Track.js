...
Track = (function() {
  function Track() {
    ...
    this.getYoutubeIframeUrl = __bind(this.getYoutubeIframeUrl, this);
    this.getYoutubeVideoId = __bind(this.getYoutubeVideoId, this);
    this.getLyrics = __bind(this.getLyrics, this);
  }
